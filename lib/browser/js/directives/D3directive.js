app.directive('treeVisual',['$compile', function($compile){
		...
		function link(scope, element, attrs){
			...
			treeJSON = d3.json("data", function(error, treeData) {
				...
				///////////////////////////
				// convert tree data into array because life.
				var treeDataIntoArray = [];
				console.log("treeData", treeData);
				treeDataIntoArray[0] = treeData.routes;
				treeData = treeDataIntoArray;
				          ...
				          .on("click", function (d) { 
				              ...
				              if (!currentNode.children && !currentNode._children) {
				                ...
				                while(tempNode.parent){
				                  pathURL = tempNode.url.concat(pathURL);
